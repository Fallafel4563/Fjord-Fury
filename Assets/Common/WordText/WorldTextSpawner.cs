...
public class WorldTextSpawner : MonoBehaviour
{
    ...
    public void SpawnText(string text, Vector3 position, Color color, Transform parent = null, int trick = 3, Transform lookTarget = null, AnimationCurve sizeCurve = null)
    {
        ...
        textInstance.GetComponent<WorldText>().SetUpText(text, color, trick, lookTarget);
